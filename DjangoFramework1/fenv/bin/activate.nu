...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/kontrpars/Desktop/eren/Python/PythonBasicApp/DjangoRestFramework/fenv'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/kontrpars/Desktop/eren/Python/PythonBasicApp/DjangoRestFramework/fenv/bin/deactivate.nu'
